...
type
  ...
  TServerSocket = class
    ...
    PETS: Array [9148 .. 10148] of TPet; // reserved 9148-10147
    ...
    DGUrsula: Array [0 .. 3] of TDungeon; //0..2
  ...
  public
    ...
    { Mob Grid }
    {function GetEmptyMobGrid(index: WORD; var pos: TPosition; radius: WORD = 6): Boolean;
    function UpdateWorld(index: Integer; var pos: TPosition; flag: BYTE): Boolean;}
  end;
{$OLDTYPELAYOUT OFF}
implementation
...
begin
 ...
 // Self.StartThreads;       // ativar para dungeons
  Self.StartPartys;
  Self.StartMobs;

  CastleSiegeHandler := TCastleSiege.Create();
 // Self.InitDungeons;      // ativar para dungeons
            ...
            begin
              ...
              if (Self.DGUrsula[i].MOBS.TMobS[CountMob].Equip[6] > 0) then
                Self.DGUrsula[i].MOBS.TMobS[CountMob].FisAtk :=
                  Self.DGUrsula[i].MOBS.TMobS[CountMob].Equip[6] +5 *dano_ursula
              else
                Self.DGUrsula[i].MOBS.TMobS[CountMob].FisAtk :=
                  Self.DGUrsula[i].MOBS.TMobS[CountMob].Equip[0]+5 *dano_ursula;
              Self.DGUrsula[i].MOBS.TMobS[CountMob].MagAtk :=
                Self.DGUrsula[i].MOBS.TMobS[CountMob].FisAtk +5 *dano_ursula;;
              Self.DGUrsula[i].MOBS.TMobS[CountMob].FisDef :=
                (Self.DGUrsula[i].MOBS.TMobS[CountMob].FisAtk * 2)+5 *dano_ursula;;
              Self.DGUrsula[i].MOBS.TMobS[CountMob].MagDef :=
                Self.DGUrsula[i].MOBS.TMobS[CountMob].FisDef +5 *dano_ursula;;
              Self.DGUrsula[i].MOBS.TMobS[CountMob].MoveSpeed := 25;
              Self.DGUrsula[i].MOBS.TMobS[CountMob].InitHP :=
                MobFileStrings[5].ToInteger() *  hp_ursula;
          ...
          begin
            ...
            begin
              ...
              Self.DGEvgInf[i].MOBS.TMobS[CountMob].Equip[6] :=
                MobFileStrings[4].ToInteger();
              Self.DGEvgInf[i].MOBS.TMobS[CountMob].MobElevation
              := MobFileStrings[8].ToInteger();
              Self.DGEvgInf[i].MOBS.TMobS[CountMob].Cabeca :=
              MobFileStrings[9].ToInteger();;
              Self.DGEvgInf[i].MOBS.TMobS[CountMob].Perna :=
              MobFileStrings[10].ToInteger();;
              if (Self.DGEvgInf[i].MOBS.TMobS[CountMob].Equip[6] > 0) then
              Self.DGEvgInf[i].MOBS.TMobS[CountMob].FisAtk :=
                Self.DGEvgInf[i].MOBS.TMobS[CountMob].Equip[6] + 5 * dano_hecla1
            else
              Self.DGEvgInf[i].MOBS.TMobS[CountMob].FisAtk :=
                Self.DGEvgInf[i].MOBS.TMobS[CountMob].Equip[0] + 5 * dano_hecla1;

            Self.DGEvgInf[i].MOBS.TMobS[CountMob].MagAtk :=
              Self.DGEvgInf[i].MOBS.TMobS[CountMob].FisAtk + 5 * dano_hecla1;
            Self.DGEvgInf[i].MOBS.TMobS[CountMob].FisDef :=
              (Self.DGEvgInf[i].MOBS.TMobS[CountMob].FisAtk * 2) + 5 * dano_hecla1;
            Self.DGEvgInf[i].MOBS.TMobS[CountMob].MagDef :=
              Self.DGEvgInf[i].MOBS.TMobS[CountMob].FisDef + 5 * dano_hecla1;

              Self.DGEvgInf[i].MOBS.TMobS[CountMob].MoveSpeed := 25;
              Self.DGEvgInf[i].MOBS.TMobS[CountMob].InitHP :=
                MobFileStrings[5].ToInteger()*hp_hecla1;
          ...
          begin
            ...
            begin
              ...
              if (Self.DGEvgSup[i].MOBS.TMobS[CountMob].Equip[6] > 0) then
                Self.DGUrsula[i].MOBS.TMobS[CountMob].FisAtk :=
                  Self.DGEvgSup[i].MOBS.TMobS[CountMob].Equip[6] +5 * dano_hecla2
              else
                Self.DGEvgSup[i].MOBS.TMobS[CountMob].FisAtk :=
                  Self.DGEvgSup[i].MOBS.TMobS[CountMob].Equip[0]+5  * dano_hecla2;
              Self.DGEvgSup[i].MOBS.TMobS[CountMob].MagAtk :=
                Self.DGEvgSup[i].MOBS.TMobS[CountMob].FisAtk +5 * dano_hecla2;
              Self.DGEvgSup[i].MOBS.TMobS[CountMob].FisDef :=
                (Self.DGEvgSup[i].MOBS.TMobS[CountMob].FisAtk * 2)+5 * dano_hecla2;
              Self.DGEvgSup[i].MOBS.TMobS[CountMob].MagDef :=
                Self.DGEvgSup[i].MOBS.TMobS[CountMob].FisDef +5 * dano_hecla2;
              Self.DGEvgSup[i].MOBS.TMobS[CountMob].MoveSpeed := 25;
              Self.DGEvgSup[i].MOBS.TMobS[CountMob].InitHP :=
                MobFileStrings[5].ToInteger()*hp_hecla2;
            ...
            begin
              ...
              if (Self.DGMines1[i].MOBS.TMobS[CountMob].Equip[6] > 0) then
                Self.DGMines1[i].MOBS.TMobS[CountMob].FisAtk :=
                  Self.DGMines1[i].MOBS.TMobS[CountMob].Equip[6]+5 *dano_mina
              else
                Self.DGMines1[i].MOBS.TMobS[CountMob].FisAtk :=
                  Self.DGMines1[i].MOBS.TMobS[CountMob].Equip[0]+5 * dano_mina;
              Self.DGMines1[i].MOBS.TMobS[CountMob].MagAtk :=
                Self.DGMines1[i].MOBS.TMobS[CountMob].FisAtk+5 * dano_mina;;
              Self.DGMines1[i].MOBS.TMobS[CountMob].FisDef :=
                (Self.DGMines1[i].MOBS.TMobS[CountMob].FisAtk * 2)+5 * dano_mina;
              Self.DGMines1[i].MOBS.TMobS[CountMob].MagDef :=
                Self.DGMines1[i].MOBS.TMobS[CountMob].FisDef+5 * dano_mina;;
              Self.DGMines1[i].MOBS.TMobS[CountMob].MoveSpeed := 25;
              Self.DGMines1[i].MOBS.TMobS[CountMob].InitHP :=
                MobFileStrings[5].ToInteger()*hp_mina;
          ...
          begin
            ...
            case Self.DGKinary[i].Dificult of
              ...
              2:
                ...
                3:
                begin
                  Self.DGKinary[i].LevelMin := FileStrings[10].ToInteger();
                  PathMobsInfo := GetCurrentDir +
                    '\Data\MobsDungeon\MobInfo_Kynari Aviary_Infernal.csv';
                  PathMobsPos := GetCurrentDir +
                    '\Data\MobsDungeon\MobsPosition_Kynari Aviary_Infernal.csv';
                  PathMobsDropNon := GetCurrentDir +
                    '\Data\Drops\kinary\701.txt';
                  PathMobsDropPrata := GetCurrentDir +
                    '\Data\Drops\kinary\702.txt';
                  PathMobsDropDourada := GetCurrentDir +
                    '\Data\Drops\kinary\703.txt';
                end;
            end;
            if not(FileExists(PathMobsInfo)) then
            begin
            ...
            begin
              ...
              if (Self.DGKinary[i].MOBS.TMobS[CountMob].Equip[6] > 0) then
                Self.DGKinary[i].MOBS.TMobS[CountMob].FisAtk :=
                  Self.DGKinary[i].MOBS.TMobS[CountMob].Equip[6]+5 *dano_ungor
              else
                Self.DGKinary[i].MOBS.TMobS[CountMob].FisAtk :=
                  Self.DGKinary[i].MOBS.TMobS[CountMob].Equip[0]+5 * dano_ungor;
              Self.DGKinary[i].MOBS.TMobS[CountMob].MagAtk :=
                Self.DGKinary[i].MOBS.TMobS[CountMob].FisAtk+5 * dano_ungor;
              Self.DGKinary[i].MOBS.TMobS[CountMob].FisDef :=
                (Self.DGKinary[i].MOBS.TMobS[CountMob].FisAtk * 2)+5 * dano_ungor;
              Self.DGKinary[i].MOBS.TMobS[CountMob].MagDef :=
                Self.DGKinary[i].MOBS.TMobS[CountMob].FisDef+5 * dano_ungor;
              Self.DGKinary[i].MOBS.TMobS[CountMob].MoveSpeed := 25;
              Self.DGKinary[i].MOBS.TMobS[CountMob].InitHP :=
                MobFileStrings[5].ToInteger()*hp_ungor;
  ...
  begin
    ...
    begin
      ...
      SQLComp.SetQuery(Format('UPDATE devires SET ' + FieldNameItemID +
        ...
        QuotedStr(TFunctions.DateTimeToUNIXTimeFAST((Self.Devires[i].Slots[j].TimeCapped)).ToString()), Self.Devires[i].Slots[j].IsAble.ToInteger,
...
var
  ...
  WeekDay, Hour, Min, Sec, MSec: Word;
  SQLComp: TQuery;
begin
  // Obtém o horário atual
  CurrentTime := Now;
  DecodeTime(CurrentTime, Hour, Min, Sec, MSec);
  WeekDay := DayOfWeek(CurrentTime);

  // Verifica se é quarta-feira às 20:45 ou sábado às 5:13
  if ((WeekDay = 2) and (Hour = 2) and (Min = 45)) or
     ((WeekDay = 4) and (Hour = 20) and (Min = 45)) or
     ((WeekDay = 7) and (Hour = 15) and (Min = 45)) then
  begin
    Logger.Write('Iniciando remoção das relíquias. Desconectando todos os jogadores...', TlogType.Warnings);

    // Desconecta todos os jogadores antes de remover as relíquias
    for i := 1 to MAX_CONNECTIONS do
    begin
      if (Players[i].Status >= Playing) then
      begin
        Logger.Write(Format('Desconectando jogador: %s', [Players[i].Base.Character.Name]), TlogType.Warnings);
        Players[i].Disconnect;
      end;
    end;

    Sleep(2000); // Aguarda 2 segundos para garantir que os jogadores foram desconectados

    Logger.Write('Todos os jogadores foram desconectados. Removendo relíquias do banco de dados...', TlogType.Warnings);
    ...
    if not(SQLComp.Query.Connection.Connected) then
    begin
      Logger.Write('Falha ao conectar ao MySQL para remover relíquias.', TlogType.Error);
      SQLComp.Destroy;
      Exit;
    end;

    // Remove apenas os IDs de relíquias nos slots, sem apagar a estrutura da tabela
    SQLComp.SetQuery('UPDATE devires SET ' +
      'slot1_itemid = 0, slot2_itemid = 0, slot3_itemid = 0, slot4_itemid = 0, slot5_itemid = 0, ' +
      'slot1_name = '''', slot2_name = '''', slot3_name = '''', slot4_name = '''', slot5_name = '''', ' +
      'slot1_timecap = NULL, slot2_timecap = NULL, slot3_timecap = NULL, slot4_timecap = NULL, slot5_timecap = NULL ' +
      'WHERE slot1_itemid > 0 OR slot2_itemid > 0 OR slot3_itemid > 0 OR slot4_itemid > 0 OR slot5_itemid > 0');

    SQLComp.Run(False);
    Logger.Write('Relíquias removidas com sucesso, estrutura mantida.', TlogType.Warnings);

    SQLComp.Destroy;

    // Atualiza todas as nações para remover os efeitos das relíquias
    Servers[Self.ChannelId].UpdateReliquaresForAll;
    Servers[Self.ChannelId].UpdateReliquareInfosForAll;

    // Remove os baús de relíquias do mapa
    for i := Low(Self.OBJ) to High(Self.OBJ) do
    begin
      if (Self.OBJ[i].ContentType = OBJECT_RELIQUARE) then
      begin
        ZeroMemory(@Self.OBJ[i], sizeof(TOBJ));  // Zera o objeto no mapa
      end;
    end;

    // Limpa os slots das relíquias na memória do servidor se não existirem mais no banco
    for i := 0 to 4 do
    begin
      for j := 0 to 4 do
      begin
        if (Self.Devires[i].Slots[j].ItemID <> 0) then
        begin
          Logger.Write(Format('Removendo relíquia da memória: Slot %d, DevirId %d', [j, i]), TlogType.Warnings);
            // 🔥 Zera completamente os dados do slot
          Self.Devires[i].Slots[j].ItemID := 0;
          Self.Devires[i].Slots[j].NameCapped := '';  // Zera o nome da relíquia
          Self.Devires[i].Slots[j].TimeCapped := 0;   // Zera o tempo de captura
          Self.Devires[i].Slots[j].Furthed := False;
          Self.Devires[i].Slots[j].TimeFurthed := 0;
          Self.Devires[i].Slots[j].IsAble := True; // Torna o slot disponível novamente
        end;
      end;
    end;
  ...
  // Atualiza os efeitos das relíquias normalmente
  ZeroMemory(@Self.ReliqEffect, sizeof(Self.ReliqEffect));
  for i := 0 to 4 do
  begin
    for j := 0 to 4 do
...
begin
  ...
  case OBJID of
    ...
    newOBJ.Index := NewId;
      ...
      newOBJ.ContentAmount := 1;
      newOBJ.ContentCollectTime := 5;
      newOBJ.ContentItemID := 4131;  // Definindo o item 4131 como o conteúdo do baú
      newOBJ.ReSpawn := false;  // O baú não reaparece
      newOBJ.CreateTime := Now;
      newOBJ.Face := 332;  // O rosto do baú será 333
      newOBJ.NameID := 914;  // Nome associado ao baú
