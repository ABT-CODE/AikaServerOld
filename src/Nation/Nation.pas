...
uses
  Windows, SysUtils, DateUtils, StrUtils, Classes, MiscData, ServerSocket, Dialogs;
{$OLDTYPELAYOUT ON}

type
  TNationCerco = packed record
    Defensoras: TGuildsAlly;
    Atacantes: ARRAY [0 .. 6] OF TGuildsAlly;
  end;
  ...
  try
    ...
    begin
      ...
      begin
       ...
       if (Self.NationID >= 1) and (Self.NationID <= 6) then
        begin
          ...
          case i of
            0:
              begin
                ...
                if (TFunctions.UNIXTimeToDateTimeFAST
                  (NationComp.Query.FieldByName('slot1_timecap').AsInteger) <>
                  DateTimeValue) then
                begin
                  Server.ReliqEffect
                  ...
                  Server.Devires[Slot].Slots[i].TimeCapped := TFunctions.UNIXTimeToDateTimeFAST(NationComp.Query.FieldByName('slot1_timecap').AsInteger);
                  TimeToEst :=IncHour(TFunctions.UNIXTimeToDateTimeFAST(NationComp.Query.FieldByName('slot1_timecap').AsInteger),RELIQ_EST_TIME);
            ...
            1:
              begin
                ...
                DateTimeValue := EncodeDateTime(2001, 1, 1, 0, 0, 0, 0);
                if (TFunctions.UNIXTimeToDateTimeFAST(NationComp.Query.FieldByName('slot2_timecap').AsInteger) <>
                  DateTimeValue) then
                begin
                  Server.ReliqEffect
                    [ItemList[Server.Devires[Slot].Slots[i].ItemID].EF[0]] :=
                  ...
                  Server.Devires[Slot].Slots[i].TimeCapped := TFunctions.UNIXTimeToDateTimeFAST(NationComp.Query.FieldByName('slot2_timecap').AsInteger);
                  TimeToEst := IncHour(TFunctions.UNIXTimeToDateTimeFAST(NationComp.Query.FieldByName('slot2_timecap').AsInteger),RELIQ_EST_TIME);
            ...
            2:
              begin
                ...
                if (TFunctions.UNIXTimeToDateTimeFAST(NationComp.Query.FieldByName('slot3_timecap').AsInteger) <>
                  DateTimeValue) then
                begin
                  Server.ReliqEffect
                    [ItemList[Server.Devires[Slot].Slots[i].ItemID].EF[0]] :=
                  ...
                  Server.Devires[Slot].Slots[i].TimeCapped := TFunctions.UNIXTimeToDateTimeFAST(NationComp.Query.FieldByName('slot3_timecap').AsInteger);
                  TimeToEst := IncHour(TFunctions.UNIXTimeToDateTimeFAST(NationComp.Query.FieldByName('slot3_timecap').AsInteger), RELIQ_EST_TIME);
            ...
            3:
              begin
                ...
                DateTimeValue := EncodeDateTime(2001, 1, 1, 0, 0, 0, 0);
                if (TFunctions.UNIXTimeToDateTimeFAST(NationComp.Query.FieldByName('slot4_timecap').AsInteger) <>
                  DateTimeValue) then
                begin
                  Server.ReliqEffect
                    [ItemList[Server.Devires[Slot].Slots[i].ItemID].EF[0]] :=
                  ...
                  Server.Devires[Slot].Slots[i].TimeCapped := TFunctions.UNIXTimeToDateTimeFAST(NationComp.Query.FieldByName('slot4_timecap').AsInteger);
                  TimeToEst := IncHour(TFunctions.UNIXTimeToDateTimeFAST(NationComp.Query.FieldByName('slot4_timecap').AsInteger),RELIQ_EST_TIME);
                  Server.Devires[Slot].Slots[i].TimeToEstabilish := TimeToEst;
                end;
                System.AnsiStrings.StrPLCopy(Server.Devires[Slot].Slots[i]
            ...
            4:
              begin
                ...
                DateTimeValue := EncodeDateTime(2001, 1, 1, 0, 0, 0, 0);
                if (TFunctions.UNIXTimeToDateTimeFAST(NationComp.Query.FieldByName('slot5_timecap').AsInteger) <>
                  DateTimeValue) then
                begin
                  Server.ReliqEffect
                    [ItemList[Server.Devires[Slot].Slots[i].ItemID].EF[0]] :=
                    ...
                    [ItemList[Server.Devires[Slot].Slots[i].ItemID].EF[0]] +
                    ItemList[Server.Devires[Slot].Slots[i].ItemID].EFV[0];
                  Server.Devires[Slot].Slots[i].TimeCapped := TFunctions.UNIXTimeToDateTimeFAST(NationComp.Query.FieldByName('slot5_timecap').AsInteger);
                  TimeToEst := IncHour(TFunctions.UNIXTimeToDateTimeFAST(NationComp.Query.FieldByName('slot5_timecap').AsInteger), RELIQ_EST_TIME);
                  Server.Devires[Slot].Slots[i].TimeToEstabilish := TimeToEst;
                end;
                System.AnsiStrings.StrPLCopy(Server.Devires[Slot].Slots[i]
