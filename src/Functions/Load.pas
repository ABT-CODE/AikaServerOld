...
begin
  ...
  Path := GetCurrentDir + '\Data\Drops\boss13.csv';
  if not(FileExists(Path)) then
  begin
    Logger.Write('O arquivo boss13.csv não foi encontrado.',
      TLogType.Warnings);
    Exit;
  end;
  AssignFile(DataFile, Path);
  ...
  begin
    ...
    case ItemType of
      DROP_NORMAL_ITEM:
        begin
          SetLength(Drops[bossdg13].NormalItems, (NormalCount + 1));
          Drops[bossdg13].NormalItems[NormalCount] :=
            FileStrings[1].ToInteger();
          inc(NormalCount);
        end;
      DROP_SUPERIOR_ITEM:
        begin
          SetLength(Drops[bossdg13].SuperiorItems, (SuperiorCount + 1));
          Drops[bossdg13].SuperiorItems[SuperiorCount] :=
            FileStrings[1].ToInteger();
          inc(SuperiorCount);
        end;
      DROP_RARE_ITEM:
        begin
          SetLength(Drops[bossdg13].RareItems, (RareCount + 1));
          Drops[bossdg13].RareItems[RareCount] :=
            FileStrings[1].ToInteger();
          inc(RareCount);
        end;
      DROP_LEGENDARY_ITEM:
        begin
          SetLength(Drops[bossdg13].LegendaryItems, (LegendaryCount + 1));
          Drops[bossdg13].LegendaryItems[LegendaryCount] :=
            FileStrings[1].ToInteger();
          inc(LegendaryCount);
        end;
    end;
  ...
  Logger.Write('bossdg13.csv carregado com sucesso.',
    TLogType.ServerStatus);

  CloseFile(DataFile);


  Path := GetCurrentDir + '\Data\Drops\boss14.csv';
  if not(FileExists(Path)) then
  begin
    Logger.Write('O arquivo boss14.csv não foi encontrado.',
      TLogType.Warnings);
    Exit;
  end;
  AssignFile(DataFile, Path);
  ...
  begin
    ...
    case ItemType of
      DROP_NORMAL_ITEM:
        begin
          SetLength(Drops[bossdg14].NormalItems, (NormalCount + 1));
          Drops[bossdg14].NormalItems[NormalCount] :=
            FileStrings[1].ToInteger();
          inc(NormalCount);
        end;
      DROP_SUPERIOR_ITEM:
        begin
          SetLength(Drops[bossdg14].SuperiorItems, (SuperiorCount + 1));
          Drops[bossdg14].SuperiorItems[SuperiorCount] :=
            FileStrings[1].ToInteger();
          inc(SuperiorCount);
        end;
      DROP_RARE_ITEM:
        begin
          SetLength(Drops[bossdg14].RareItems, (RareCount + 1));
          Drops[bossdg14].RareItems[RareCount] :=
            FileStrings[1].ToInteger();
          inc(RareCount);
        end;
      DROP_LEGENDARY_ITEM:
        begin
          SetLength(Drops[bossdg14].LegendaryItems, (LegendaryCount + 1));
          Drops[bossdg14].LegendaryItems[LegendaryCount] :=
            FileStrings[1].ToInteger();
          inc(LegendaryCount);
        end;
    end;
  ...
  Logger.Write('bossdg14.csv carregado com sucesso.',
    TLogType.ServerStatus);
  ...
  Path := GetCurrentDir + '\Data\Drops\boss15.csv';
  if not(FileExists(Path)) then
  begin
    Logger.Write('O arquivo boss15.csv não foi encontrado.',
      TLogType.Warnings);
    Exit;
  end;
  AssignFile(DataFile, Path);
  ...
  begin
    ...
    case ItemType of
      DROP_NORMAL_ITEM:
        begin
          SetLength(Drops[bossdg15].NormalItems, (NormalCount + 1));
          Drops[bossdg15].NormalItems[NormalCount] :=
            FileStrings[1].ToInteger();
          inc(NormalCount);
        end;
      DROP_SUPERIOR_ITEM:
        begin
          SetLength(Drops[bossdg15].SuperiorItems, (SuperiorCount + 1));
          Drops[bossdg15].SuperiorItems[SuperiorCount] :=
            FileStrings[1].ToInteger();
          inc(SuperiorCount);
        end;
      DROP_RARE_ITEM:
        begin
          SetLength(Drops[bossdg15].RareItems, (RareCount + 1));
          Drops[bossdg15].RareItems[RareCount] :=
            FileStrings[1].ToInteger();
          inc(RareCount);
        end;
      DROP_LEGENDARY_ITEM:
        begin
          SetLength(Drops[bossdg15].LegendaryItems, (LegendaryCount + 1));
          Drops[bossdg15].LegendaryItems[LegendaryCount] :=
            FileStrings[1].ToInteger();
          inc(LegendaryCount);
        end;
    end;
  ...
  Logger.Write('bossdg15.csv carregado com sucesso.',
    TLogType.ServerStatus);

  CloseFile(DataFile);


  Path := GetCurrentDir + '\Data\Drops\boss141.csv';
  if not(FileExists(Path)) then
  begin
    Logger.Write('O arquivo boss141.csv não foi encontrado.',
      TLogType.Warnings);
    Exit;
  end;
  AssignFile(DataFile, Path);
  ...
  begin
    ...
    case ItemType of
      DROP_NORMAL_ITEM:
        begin
          SetLength(Drops[bossdg141].NormalItems, (NormalCount + 1));
          Drops[bossdg141].NormalItems[NormalCount] :=
            FileStrings[1].ToInteger();
          inc(NormalCount);
        end;
      DROP_SUPERIOR_ITEM:
        begin
          SetLength(Drops[bossdg141].SuperiorItems, (SuperiorCount + 1));
          Drops[bossdg141].SuperiorItems[SuperiorCount] :=
            FileStrings[1].ToInteger();
          inc(SuperiorCount);
        end;
      DROP_RARE_ITEM:
        begin
          SetLength(Drops[bossdg141].RareItems, (RareCount + 1));
          Drops[bossdg141].RareItems[RareCount] :=
            FileStrings[1].ToInteger();
          inc(RareCount);
        end;
      DROP_LEGENDARY_ITEM:
        begin
          SetLength(Drops[bossdg141].LegendaryItems, (LegendaryCount + 1));
          Drops[bossdg141].LegendaryItems[LegendaryCount] :=
            FileStrings[1].ToInteger();
          inc(LegendaryCount);
        end;
    end;
  ...
  Logger.Write('bossdg141.csv carregado com sucesso.',
    TLogType.ServerStatus);

  CloseFile(DataFile);


  Path := GetCurrentDir + '\Data\Drops\boss12.csv';
  if not(FileExists(Path)) then
  begin
    Logger.Write('O arquivo boss12.csv não foi encontrado.',
      TLogType.Warnings);
    Exit;
  end;
  AssignFile(DataFile, Path);
  ...
  begin
    ...
    case ItemType of
      DROP_NORMAL_ITEM:
        begin
          SetLength(Drops[bossdg12].NormalItems, (NormalCount + 1));
          Drops[bossdg12].NormalItems[NormalCount] :=
            FileStrings[1].ToInteger();
          inc(NormalCount);
        end;
      DROP_SUPERIOR_ITEM:
        begin
          SetLength(Drops[bossdg12].SuperiorItems, (SuperiorCount + 1));
          Drops[bossdg12].SuperiorItems[SuperiorCount] :=
            FileStrings[1].ToInteger();
          inc(SuperiorCount);
        end;
      DROP_RARE_ITEM:
        begin
          SetLength(Drops[bossdg12].RareItems, (RareCount + 1));
          Drops[bossdg12].RareItems[RareCount] :=
            FileStrings[1].ToInteger();
          inc(RareCount);
        end;
      DROP_LEGENDARY_ITEM:
        begin
          SetLength(Drops[bossdg12].LegendaryItems, (LegendaryCount + 1));
          Drops[bossdg12].LegendaryItems[LegendaryCount] :=
            FileStrings[1].ToInteger();
          inc(LegendaryCount);
        end;
    end;
  ...
  Logger.Write('boss12.csv carregado com sucesso.',
    TLogType.ServerStatus);
  ...
  Path := GetCurrentDir + '\Data\Drops\dropdg.csv';
  if not(FileExists(Path)) then
  begin
    Logger.Write('O arquivo dropdg.csv não foi encontrado.',
      TLogType.Warnings);
    Exit;
  end;
  AssignFile(DataFile, Path);
  ...
  begin
    ...
    case ItemType of
      DROP_NORMAL_ITEM:
        begin
          SetLength(Drops[dropdg].NormalItems, (NormalCount + 1));
          Drops[dropdg].NormalItems[NormalCount] :=
            FileStrings[1].ToInteger();
          inc(NormalCount);
        end;
      DROP_SUPERIOR_ITEM:
        begin
          SetLength(Drops[dropdg].SuperiorItems, (SuperiorCount + 1));
          Drops[dropdg].SuperiorItems[SuperiorCount] :=
            FileStrings[1].ToInteger();
          inc(SuperiorCount);
        end;
      DROP_RARE_ITEM:
        begin
          SetLength(Drops[dropdg].RareItems, (RareCount + 1));
          Drops[dropdg].RareItems[RareCount] :=
            FileStrings[1].ToInteger();
          inc(RareCount);
        end;
      DROP_LEGENDARY_ITEM:
        begin
          SetLength(Drops[dropdg].LegendaryItems, (LegendaryCount + 1));
          Drops[dropdg].LegendaryItems[LegendaryCount] :=
            FileStrings[1].ToInteger();
          inc(LegendaryCount);
        end;
    end;
  ...
  Logger.Write('dropdg.csv carregado com sucesso.',
    TLogType.ServerStatus);
  ...
  Path := GetCurrentDir + '\Data\Drops\dro80.csv';
  if not(FileExists(Path)) then
  begin
    Logger.Write('O arquivo dro80.csv não foi encontrado.',
      TLogType.Warnings);
    Exit;
  end;
  AssignFile(DataFile, Path);
  ...
  begin
    ...
    case ItemType of
      DROP_NORMAL_ITEM:
        begin
          SetLength(Drops[dro80].NormalItems, (NormalCount + 1));
          Drops[dro80].NormalItems[NormalCount] :=
            FileStrings[1].ToInteger();
          inc(NormalCount);
        end;
      DROP_SUPERIOR_ITEM:
        begin
          SetLength(Drops[dro80].SuperiorItems, (SuperiorCount + 1));
          Drops[dro80].SuperiorItems[SuperiorCount] :=
            FileStrings[1].ToInteger();
          inc(SuperiorCount);
        end;
      DROP_RARE_ITEM:
        begin
          SetLength(Drops[dro80].RareItems, (RareCount + 1));
          Drops[dro80].RareItems[RareCount] :=
            FileStrings[1].ToInteger();
          inc(RareCount);
        end;
      DROP_LEGENDARY_ITEM:
        begin
          SetLength(Drops[dro80].LegendaryItems, (LegendaryCount + 1));
          Drops[dro80].LegendaryItems[LegendaryCount] :=
            FileStrings[1].ToInteger();
          inc(LegendaryCount);
        end;
    end;
  ...
  Logger.Write('dro80.csv carregado com sucesso.',
    TLogType.ServerStatus);

  CloseFile(DataFile);

  Path := GetCurrentDir + '\Data\Drops\bossevento.csv';
  if not(FileExists(Path)) then
  begin
    Logger.Write('O arquivo bossevento.csv não foi encontrado.',
      TLogType.Warnings);
    Exit;
  end;
  AssignFile(DataFile, Path);
  ...
  begin
    ...
    case ItemType of
      DROP_NORMAL_ITEM:
        begin
          SetLength(Drops[bossevento].NormalItems, (NormalCount + 1));
          Drops[bossevento].NormalItems[NormalCount] :=
            FileStrings[1].ToInteger();
          inc(NormalCount);
        end;
      DROP_SUPERIOR_ITEM:
        begin
          SetLength(Drops[bossevento].SuperiorItems, (SuperiorCount + 1));
          Drops[bossevento].SuperiorItems[SuperiorCount] :=
            FileStrings[1].ToInteger();
          inc(SuperiorCount);
        end;
      DROP_RARE_ITEM:
        begin
          SetLength(Drops[bossevento].RareItems, (RareCount + 1));
          Drops[bossevento].RareItems[RareCount] :=
            FileStrings[1].ToInteger();
          inc(RareCount);
        end;
      DROP_LEGENDARY_ITEM:
        begin
          SetLength(Drops[bossevento].LegendaryItems, (LegendaryCount + 1));
          Drops[bossevento].LegendaryItems[LegendaryCount] :=
            FileStrings[1].ToInteger();
          inc(LegendaryCount);
        end;
    end;
  ...
  Logger.Write('bossevento.csv carregado com sucesso.',
    TLogType.ServerStatus);

  CloseFile(DataFile);


  Path := GetCurrentDir + '\Data\Drops\leopold1.csv';
  if not(FileExists(Path)) then
  begin
    Logger.Write('O arquivo leopold1.csv não foi encontrado.',
      TLogType.Warnings);
    Exit;
  end;
  AssignFile(DataFile, Path);
  ...
  begin
    ...
    case ItemType of
      DROP_NORMAL_ITEM:
        begin
          SetLength(Drops[leopold1].NormalItems, (NormalCount + 1));
          Drops[leopold1].NormalItems[NormalCount] :=
            FileStrings[1].ToInteger();
          inc(NormalCount);
        end;
      DROP_SUPERIOR_ITEM:
        begin
          SetLength(Drops[leopold1].SuperiorItems, (SuperiorCount + 1));
          Drops[leopold1].SuperiorItems[SuperiorCount] :=
            FileStrings[1].ToInteger();
          inc(SuperiorCount);
        end;
      DROP_RARE_ITEM:
        begin
          SetLength(Drops[leopold1].RareItems, (RareCount + 1));
          Drops[leopold1].RareItems[RareCount] :=
            FileStrings[1].ToInteger();
          inc(RareCount);
        end;
      DROP_LEGENDARY_ITEM:
        begin
          SetLength(Drops[leopold1].LegendaryItems, (LegendaryCount + 1));
          Drops[leopold1].LegendaryItems[LegendaryCount] :=
            FileStrings[1].ToInteger();
          inc(LegendaryCount);
        end;
    end;
  ...
  Logger.Write('leopold1.csv carregado com sucesso.',
    TLogType.ServerStatus);

  CloseFile(DataFile);


  Path := GetCurrentDir + '\Data\Drops\leopold2.csv';
  if not(FileExists(Path)) then
  begin
    Logger.Write('O arquivo leopold2.csv não foi encontrado.',
      TLogType.Warnings);
    Exit;
  end;
  AssignFile(DataFile, Path);
  ...
  begin
    ...
    case ItemType of
      DROP_NORMAL_ITEM:
        begin
          SetLength(Drops[leopold2].NormalItems, (NormalCount + 1));
          Drops[leopold2].NormalItems[NormalCount] :=
            FileStrings[1].ToInteger();
          inc(NormalCount);
        end;
      DROP_SUPERIOR_ITEM:
        begin
          SetLength(Drops[leopold2].SuperiorItems, (SuperiorCount + 1));
          Drops[leopold2].SuperiorItems[SuperiorCount] :=
            FileStrings[1].ToInteger();
          inc(SuperiorCount);
        end;
      DROP_RARE_ITEM:
        begin
          SetLength(Drops[leopold2].RareItems, (RareCount + 1));
          Drops[leopold2].RareItems[RareCount] :=
            FileStrings[1].ToInteger();
          inc(RareCount);
        end;
      DROP_LEGENDARY_ITEM:
        begin
          SetLength(Drops[leopold2].LegendaryItems, (LegendaryCount + 1));
          Drops[leopold2].LegendaryItems[LegendaryCount] :=
            FileStrings[1].ToInteger();
          inc(LegendaryCount);
        end;
    end;
  ...
  Logger.Write('leopold2.csv carregado com sucesso.',
    TLogType.ServerStatus);
  ...
  // drops dgs PVE
   ...
   Path := GetCurrentDir + '\Data\Drops\heclasuperior.csv';
  if not(FileExists(Path)) then
  begin
    Logger.Write('O arquivo heclasuperior.csv não foi encontrado.',
      TLogType.Warnings);
    Exit;
  end;
  AssignFile(DataFile, Path);
  ...
  begin
    ...
    case ItemType of
      DROP_NORMAL_ITEM:
        begin
          SetLength(Drops[heclasuperior].NormalItems, (NormalCount + 1));
          Drops[heclasuperior].NormalItems[NormalCount] :=
            FileStrings[1].ToInteger();
          inc(NormalCount);
        end;
      DROP_SUPERIOR_ITEM:
        begin
          SetLength(Drops[heclasuperior].SuperiorItems, (SuperiorCount + 1));
          Drops[heclasuperior].SuperiorItems[SuperiorCount] :=
            FileStrings[1].ToInteger();
          inc(SuperiorCount);
        end;
      DROP_RARE_ITEM:
        begin
          SetLength(Drops[heclasuperior].RareItems, (RareCount + 1));
          Drops[heclasuperior].RareItems[RareCount] :=
            FileStrings[1].ToInteger();
          inc(RareCount);
        end;
      DROP_LEGENDARY_ITEM:
        begin
          SetLength(Drops[heclasuperior].LegendaryItems, (LegendaryCount + 1));
          Drops[heclasuperior].LegendaryItems[LegendaryCount] :=
            FileStrings[1].ToInteger();
          inc(LegendaryCount);
        end;
    end;
  ...
  Logger.Write('heclasuperior.csv carregado com sucesso.',
    TLogType.ServerStatus);

  CloseFile(DataFile);


  Path := GetCurrentDir + '\Data\Drops\heclasuperiorboss.csv';
  if not(FileExists(Path)) then
  begin
    Logger.Write('O arquivo heclasuperiorboss.csv não foi encontrado.',
      TLogType.Warnings);
    Exit;
  end;
  AssignFile(DataFile, Path);
  ...
  begin
    ...
    case ItemType of
      DROP_NORMAL_ITEM:
        begin
          SetLength(Drops[heclasuperiorboss].NormalItems, (NormalCount + 1));
          Drops[heclasuperiorboss].NormalItems[NormalCount] :=
            FileStrings[1].ToInteger();
          inc(NormalCount);
        end;
      DROP_SUPERIOR_ITEM:
        begin
          SetLength(Drops[heclasuperiorboss].SuperiorItems, (SuperiorCount + 1));
          Drops[heclasuperiorboss].SuperiorItems[SuperiorCount] :=
            FileStrings[1].ToInteger();
          inc(SuperiorCount);
        end;
      DROP_RARE_ITEM:
        begin
          SetLength(Drops[heclasuperiorboss].RareItems, (RareCount + 1));
          Drops[heclasuperiorboss].RareItems[RareCount] :=
            FileStrings[1].ToInteger();
          inc(RareCount);
        end;
      DROP_LEGENDARY_ITEM:
        begin
          SetLength(Drops[heclasuperiorboss].LegendaryItems, (LegendaryCount + 1));
          Drops[heclasuperiorboss].LegendaryItems[LegendaryCount] :=
            FileStrings[1].ToInteger();
          inc(LegendaryCount);
        end;
    end;
  ...
  Logger.Write('heclasuperiorboss.csv carregado com sucesso.',
    TLogType.ServerStatus);
  ...
  //>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
   ...
   Path := GetCurrentDir + '\Data\Drops\heclainferior.csv';
  if not(FileExists(Path)) then
  begin
    Logger.Write('O arquivo heclainferior.csv não foi encontrado.',
      TLogType.Warnings);
    Exit;
  end;
  AssignFile(DataFile, Path);
  ...
  begin
    ...
    case ItemType of
      DROP_NORMAL_ITEM:
        begin
          SetLength(Drops[heclainferior].NormalItems, (NormalCount + 1));
          Drops[heclainferior].NormalItems[NormalCount] :=
            FileStrings[1].ToInteger();
          inc(NormalCount);
        end;
      DROP_SUPERIOR_ITEM:
        begin
          SetLength(Drops[heclainferior].SuperiorItems, (SuperiorCount + 1));
          Drops[heclainferior].SuperiorItems[SuperiorCount] :=
            FileStrings[1].ToInteger();
          inc(SuperiorCount);
        end;
      DROP_RARE_ITEM:
        begin
          SetLength(Drops[heclainferior].RareItems, (RareCount + 1));
          Drops[heclainferior].RareItems[RareCount] :=
            FileStrings[1].ToInteger();
          inc(RareCount);
        end;
      DROP_LEGENDARY_ITEM:
        begin
          SetLength(Drops[heclainferior].LegendaryItems, (LegendaryCount + 1));
          Drops[heclainferior].LegendaryItems[LegendaryCount] :=
            FileStrings[1].ToInteger();
          inc(LegendaryCount);
        end;
    end;
  ...
  Logger.Write('heclainferior.csv carregado com sucesso.',
    TLogType.ServerStatus);

  CloseFile(DataFile);


  Path := GetCurrentDir + '\Data\Drops\heclainferiorboss.csv';
  if not(FileExists(Path)) then
  begin
    Logger.Write('O arquivo heclainferiorboss.csv não foi encontrado.',
      TLogType.Warnings);
    Exit;
  end;
  AssignFile(DataFile, Path);
  ...
  begin
    ...
    case ItemType of
      DROP_NORMAL_ITEM:
        begin
          SetLength(Drops[heclainferiorboss].NormalItems, (NormalCount + 1));
          Drops[heclainferiorboss].NormalItems[NormalCount] :=
            FileStrings[1].ToInteger();
          inc(NormalCount);
        end;
      DROP_SUPERIOR_ITEM:
        begin
          SetLength(Drops[heclainferiorboss].SuperiorItems, (SuperiorCount + 1));
          Drops[heclainferiorboss].SuperiorItems[SuperiorCount] :=
            FileStrings[1].ToInteger();
          inc(SuperiorCount);
        end;
      DROP_RARE_ITEM:
        begin
          SetLength(Drops[heclainferiorboss].RareItems, (RareCount + 1));
          Drops[heclainferiorboss].RareItems[RareCount] :=
            FileStrings[1].ToInteger();
          inc(RareCount);
        end;
      DROP_LEGENDARY_ITEM:
        begin
          SetLength(Drops[heclainferiorboss].LegendaryItems, (LegendaryCount + 1));
          Drops[heclainferiorboss].LegendaryItems[LegendaryCount] :=
            FileStrings[1].ToInteger();
          inc(LegendaryCount);
        end;
    end;
  ...
  Logger.Write('heclainferiorboss.csv carregado com sucesso.',
    TLogType.ServerStatus);
...
//>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
   ...
   Path := GetCurrentDir + '\Data\Drops\mina1.csv';
  if not(FileExists(Path)) then
  begin
    Logger.Write('O arquivo mina1.csv não foi encontrado.',
      TLogType.Warnings);
    Exit;
  end;
  AssignFile(DataFile, Path);
  ...
  begin
    ...
    case ItemType of
      DROP_NORMAL_ITEM:
        begin
          SetLength(Drops[mina1].NormalItems, (NormalCount + 1));
          Drops[mina1].NormalItems[NormalCount] :=
            FileStrings[1].ToInteger();
          inc(NormalCount);
        end;
      DROP_SUPERIOR_ITEM:
        begin
          SetLength(Drops[mina1].SuperiorItems, (SuperiorCount + 1));
          Drops[mina1].SuperiorItems[SuperiorCount] :=
            FileStrings[1].ToInteger();
          inc(SuperiorCount);
        end;
      DROP_RARE_ITEM:
        begin
          SetLength(Drops[mina1].RareItems, (RareCount + 1));
          Drops[mina1].RareItems[RareCount] :=
            FileStrings[1].ToInteger();
          inc(RareCount);
        end;
      DROP_LEGENDARY_ITEM:
        begin
          SetLength(Drops[mina1].LegendaryItems, (LegendaryCount + 1));
          Drops[mina1].LegendaryItems[LegendaryCount] :=
            FileStrings[1].ToInteger();
          inc(LegendaryCount);
        end;
    end;
  ...
  Logger.Write('mina1.csv carregado com sucesso.',
    TLogType.ServerStatus);

  CloseFile(DataFile);


  Path := GetCurrentDir + '\Data\Drops\mina1boss.csv';
  if not(FileExists(Path)) then
  begin
    Logger.Write('O arquivo mina1boss.csv não foi encontrado.',
      TLogType.Warnings);
    Exit;
  end;
  AssignFile(DataFile, Path);
  ...
  begin
    ...
    case ItemType of
      DROP_NORMAL_ITEM:
        begin
          SetLength(Drops[mina1boss].NormalItems, (NormalCount + 1));
          Drops[mina1boss].NormalItems[NormalCount] :=
            FileStrings[1].ToInteger();
          inc(NormalCount);
        end;
      DROP_SUPERIOR_ITEM:
        begin
          SetLength(Drops[mina1boss].SuperiorItems, (SuperiorCount + 1));
          Drops[mina1boss].SuperiorItems[SuperiorCount] :=
            FileStrings[1].ToInteger();
          inc(SuperiorCount);
        end;
      DROP_RARE_ITEM:
        begin
          SetLength(Drops[mina1boss].RareItems, (RareCount + 1));
          Drops[mina1boss].RareItems[RareCount] :=
            FileStrings[1].ToInteger();
          inc(RareCount);
        end;
      DROP_LEGENDARY_ITEM:
        begin
          SetLength(Drops[mina1boss].LegendaryItems, (LegendaryCount + 1));
          Drops[mina1boss].LegendaryItems[LegendaryCount] :=
            FileStrings[1].ToInteger();
          inc(LegendaryCount);
        end;
    end;
  ...
  Logger.Write('mina1boss.csv carregado com sucesso.',
    TLogType.ServerStatus);
  ...
  //Dg ungor >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
   ...
   Path := GetCurrentDir + '\Data\Drops\ungor.csv';
  if not(FileExists(Path)) then
  begin
    Logger.Write('O arquivo ungor.csv não foi encontrado.',
      TLogType.Warnings);
    Exit;
  end;
  AssignFile(DataFile, Path);
  ...
  begin
    ...
    case ItemType of
      DROP_NORMAL_ITEM:
        begin
          SetLength(Drops[ungor].NormalItems, (NormalCount + 1));
          Drops[ungor].NormalItems[NormalCount] :=
            FileStrings[1].ToInteger();
          inc(NormalCount);
        end;
      DROP_SUPERIOR_ITEM:
        begin
          SetLength(Drops[ungor].SuperiorItems, (SuperiorCount + 1));
          Drops[ungor].SuperiorItems[SuperiorCount] :=
            FileStrings[1].ToInteger();
          inc(SuperiorCount);
        end;
      DROP_RARE_ITEM:
        begin
          SetLength(Drops[ungor].RareItems, (RareCount + 1));
          Drops[ungor].RareItems[RareCount] :=
            FileStrings[1].ToInteger();
          inc(RareCount);
        end;
      DROP_LEGENDARY_ITEM:
        begin
          SetLength(Drops[ungor].LegendaryItems, (LegendaryCount + 1));
          Drops[ungor].LegendaryItems[LegendaryCount] :=
            FileStrings[1].ToInteger();
          inc(LegendaryCount);
        end;
    end;
  ...
  Logger.Write('ungor.csv carregado com sucesso.',
    TLogType.ServerStatus);
  ...
  CloseFile(DataFile);
   ...
   Path := GetCurrentDir + '\Data\Drops\ungorboss.csv';
  if not(FileExists(Path)) then
  begin
    Logger.Write('O arquivo ungorboss.csv não foi encontrado.',
      TLogType.Warnings);
    Exit;
  end;
  AssignFile(DataFile, Path);
  ...
  begin
    ...
    case ItemType of
      DROP_NORMAL_ITEM:
        begin
          SetLength(Drops[ungorboss].NormalItems, (NormalCount + 1));
          Drops[ungorboss].NormalItems[NormalCount] :=
            FileStrings[1].ToInteger();
          inc(NormalCount);
        end;
      DROP_SUPERIOR_ITEM:
        begin
          SetLength(Drops[ungorboss].SuperiorItems, (SuperiorCount + 1));
          Drops[ungorboss].SuperiorItems[SuperiorCount] :=
            FileStrings[1].ToInteger();
          inc(SuperiorCount);
        end;
      DROP_RARE_ITEM:
        begin
          SetLength(Drops[ungorboss].RareItems, (RareCount + 1));
          Drops[ungorboss].RareItems[RareCount] :=
            FileStrings[1].ToInteger();
          inc(RareCount);
        end;
      DROP_LEGENDARY_ITEM:
        begin
          SetLength(Drops[ungorboss].LegendaryItems, (LegendaryCount + 1));
          Drops[ungorboss].LegendaryItems[LegendaryCount] :=
            FileStrings[1].ToInteger();
          inc(LegendaryCount);
        end;
    end;
  ...
  Logger.Write('ungorboss.csv carregado com sucesso.',
    TLogType.ServerStatus);

  CloseFile(DataFile);


  Path := GetCurrentDir + '\Data\Drops\ungorboss2.csv';
  if not(FileExists(Path)) then
  begin
    Logger.Write('O arquivo ungorboss2.csv não foi encontrado.',
      TLogType.Warnings);
    Exit;
  end;
  AssignFile(DataFile, Path);
  ...
  begin
    ...
    case ItemType of
      DROP_NORMAL_ITEM:
        begin
          SetLength(Drops[ungorboss2].NormalItems, (NormalCount + 1));
          Drops[ungorboss2].NormalItems[NormalCount] :=
            FileStrings[1].ToInteger();
          inc(NormalCount);
        end;
      DROP_SUPERIOR_ITEM:
        begin
          SetLength(Drops[ungorboss2].SuperiorItems, (SuperiorCount + 1));
          Drops[ungorboss2].SuperiorItems[SuperiorCount] :=
            FileStrings[1].ToInteger();
          inc(SuperiorCount);
        end;
      DROP_RARE_ITEM:
        begin
          SetLength(Drops[ungorboss2].RareItems, (RareCount + 1));
          Drops[ungorboss2].RareItems[RareCount] :=
            FileStrings[1].ToInteger();
          inc(RareCount);
        end;
      DROP_LEGENDARY_ITEM:
        begin
          SetLength(Drops[ungorboss2].LegendaryItems, (LegendaryCount + 1));
          Drops[ungorboss2].LegendaryItems[LegendaryCount] :=
            FileStrings[1].ToInteger();
          inc(LegendaryCount);
        end;
    end;
  ...
  Logger.Write('ungorboss2.csv carregado com sucesso.',
    TLogType.ServerStatus);

  CloseFile(DataFile);

 // drop reliquiasBoss Zelandes

  //Dg ungor >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>

   Path := GetCurrentDir + '\Data\Drops\zelandes.csv';
  if not(FileExists(Path)) then
  begin
    Logger.Write('O arquivo zelandes.csv não foi encontrado.',
      TLogType.Warnings);
    Exit;
  end;
  AssignFile(DataFile, Path);
  ...
  begin
    ...
    case ItemType of
      DROP_NORMAL_ITEM:
        begin
          SetLength(Drops[zelandes].NormalItems, (NormalCount + 1));
          Drops[zelandes].NormalItems[NormalCount] :=
            FileStrings[1].ToInteger();
          inc(NormalCount);
        end;
      DROP_SUPERIOR_ITEM:
        begin
          SetLength(Drops[zelandes].SuperiorItems, (SuperiorCount + 1));
          Drops[zelandes].SuperiorItems[SuperiorCount] :=
            FileStrings[1].ToInteger();
          inc(SuperiorCount);
        end;
      DROP_RARE_ITEM:
        begin
          SetLength(Drops[zelandes].RareItems, (RareCount + 1));
          Drops[zelandes].RareItems[RareCount] :=
            FileStrings[1].ToInteger();
          inc(RareCount);
        end;
      DROP_LEGENDARY_ITEM:
        begin
          SetLength(Drops[zelandes].LegendaryItems, (LegendaryCount + 1));
          Drops[zelandes].LegendaryItems[LegendaryCount] :=
            FileStrings[1].ToInteger();
          inc(LegendaryCount);
        end;
    end;
  ...
  Logger.Write('zelandes.csv carregado com sucesso.',
    TLogType.ServerStatus);
...
begin
        ...
        3339: //devir zelant
          begin
            ...
            System.Ansistrings.StrPlCopy(Servers[I].DevirGuards[3369]
              .PlayerChar.Base.Name, '941', 3);
            Servers[I].DevirGuards[3369].PlayerChar.LastPos.X := 2241;
            Servers[I].DevirGuards[3369].PlayerChar.LastPos.Y := 952;
            ...
            Servers[I].DevirGuards[3369].PlayerChar.Base.CurrentScore.Sizes.
              ...
              Servers[I].DevirGuards[3369].PlayerChar.Base.Equip[0].Index := 60;
            Servers[I].DevirGuards[3369].PlayerChar.Base.Equip[0].APP := 60;
            //elmo
             Servers[I].DevirGuards[3369].PlayerChar.Base.Equip[2].Index := 12963;
            Servers[I].DevirGuards[3369].PlayerChar.Base.Equip[2].APP := 12963;
            //armadura
             Servers[I].DevirGuards[3369].PlayerChar.Base.Equip[3].Index := 12993;
            Servers[I].DevirGuards[3369].PlayerChar.Base.Equip[3].APP := 12993;
            //luva
             Servers[I].DevirGuards[3369].PlayerChar.Base.Equip[4].Index := 13023;
            Servers[I].DevirGuards[3369].PlayerChar.Base.Equip[4].APP := 13023;
            // bota
             Servers[I].DevirGuards[3369].PlayerChar.Base.Equip[5].Index := 13053;
            Servers[I].DevirGuards[3369].PlayerChar.Base.Equip[5].APP := 13053;
            // arma
             Servers[I].DevirGuards[3369].PlayerChar.Base.Equip[6].Index := 12298;
            Servers[I].DevirGuards[3369].PlayerChar.Base.Equip[6].APP := 12298;
            // escudo
           // Servers[I].DevirGuards[3369].PlayerChar.Base.Equip[7].Index := 1442;
           // Servers[I].DevirGuards[3369].PlayerChar.Base.Equip[7].APP := 1442;


            Servers[I].DevirGuards[3369].PlayerChar.Base.CurrentScore.MaxHp :=
              MOB_GUARD_HP+ 9999999;
            ...
            // guarda azul Novo
           { Servers[I].DevirGuards[3374].PlayerChar.Base.ClientId := 3374;
            System.Ansistrings.StrPlCopy(Servers[I].DevirGuards[3374]
              .PlayerChar.Base.Name, '942', 3);
            Servers[I].DevirGuards[3374].PlayerChar.LastPos.X := 2929;
            Servers[I].DevirGuards[3374].PlayerChar.LastPos.Y := 1658;
            Servers[I].DevirGuards[3374].FirstPosition :=
              Servers[I].DevirGuards[3374].PlayerChar.LastPos;
            Servers[I].DevirGuards[3374].PlayerChar.Base.Nation :=
              Servers[I].NationID;
            Servers[I].DevirGuards[3374].PlayerChar.Base.CurrentScore.Sizes.
              Altura := 7;
            Servers[I].DevirGuards[3374].PlayerChar.Base.CurrentScore.Sizes.
              Tronco := 119;
            Servers[I].DevirGuards[3374].PlayerChar.Base.CurrentScore.Sizes.
            ...
            Servers[I].DevirGuards[3374].PlayerChar.Base.CurrentScore.Sizes.
              Corpo := 0;
            Servers[I].DevirGuards[3374].PlayerChar.Base.Equip[0].Index := 60;
            Servers[I].DevirGuards[3374].PlayerChar.Base.Equip[0].APP := 60;
            //elmo
             Servers[I].DevirGuards[3374].PlayerChar.Base.Equip[2].Index := 12963;
            Servers[I].DevirGuards[3374].PlayerChar.Base.Equip[2].APP := 12963;
            //armadura
             Servers[I].DevirGuards[3374].PlayerChar.Base.Equip[3].Index := 12993;
            Servers[I].DevirGuards[3374].PlayerChar.Base.Equip[3].APP := 12993;
            //luva
             Servers[I].DevirGuards[3374].PlayerChar.Base.Equip[4].Index := 13023;
            Servers[I].DevirGuards[3374].PlayerChar.Base.Equip[4].APP := 13023;
            // bota
             Servers[I].DevirGuards[3374].PlayerChar.Base.Equip[5].Index := 13053;
            Servers[I].DevirGuards[3374].PlayerChar.Base.Equip[5].APP := 13053;
            // arma
             Servers[I].DevirGuards[3374].PlayerChar.Base.Equip[6].Index := 12298;
            Servers[I].DevirGuards[3374].PlayerChar.Base.Equip[6].APP := 12298;
            // escudo
           // Servers[I].DevirGuards[3374].PlayerChar.Base.Equip[7].Index := 1442;
           // Servers[I].DevirGuards[3374].PlayerChar.Base.Equip[7].APP := 1442;

            Servers[I].DevirGuards[3374].PlayerChar.Base.CurrentScore.MaxHp :=
              MOB_GUARD_HP;
            Servers[I].DevirGuards[3374].PlayerChar.Base.CurrentScore.CurHP :=
              MOB_GUARD_HP;
            Servers[I].DevirGuards[3374].PlayerChar.DuploAtk := $4B;
            Servers[I].DevirGuards[3374].Base.Create(
            @Servers[I].DevirGuards[3374].PlayerChar.Base, 3374, I);  }
  ...
  begin
    ...
    Inc(InstantiatedNPCs);
     ...
     // bandeira evento de bandeira

    {Servers[I].CastleObjects[3374].PlayerChar.Base.ClientId := 3374;
    System.Ansistrings.StrPlCopy(Servers[I].CastleObjects[3374]
      .PlayerChar.Base.Name, '1017', 4);
    Servers[I].CastleObjects[3374].PlayerChar.LastPos.X := 3143;
    Servers[I].CastleObjects[3374].PlayerChar.LastPos.Y := 3016.75;

    Servers[I].CastleObjects[3374].PlayerChar.Base.Nation :=
      Servers[I].NationID;
    Servers[I].CastleObjects[3374].PlayerChar.Base.CurrentScore.Sizes.
      Altura := 0;
    Servers[I].CastleObjects[3374].PlayerChar.Base.CurrentScore.Sizes.
      Tronco := 135;
    Servers[I].CastleObjects[3374].PlayerChar.Base.CurrentScore.Sizes.
    ...
    Servers[I].CastleObjects[3374].PlayerChar.Base.CurrentScore.MaxHp :=
      30000;

    Servers[I].CastleObjects[3374].PlayerChar.Base.Equip[0].Index := 5722;
      Servers[I].CastleObjects[3374].PlayerChar.Base.Equip[0].APP := 5722;

    Servers[I].CastleObjects[3374].Base.Create(
      @Servers[I].CastleObjects[3374].PlayerChar.Base, 3374, I);
