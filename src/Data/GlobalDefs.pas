...
uses
  ...
  Generics.Collections, GuildData, Nation, Dungeon, Player,SysUtils, DateUtils ;
var
  Logger: TLog;
  WebServerClosed: Boolean;
  Servers: ARRAY OF TServerSocket;
  Nations: Array [0..6] of TNationData;
  ...
  DungeonInstances: Array [1 .. 10] of TDungeonInstance;
...
{$ENDREGION}
 ...
 Reinforce3: ARRAY OF ArmorAttributeReinforce;
  ...
  MOB_STONE_DEVIR_DEF: WORD = 12000;
  MOB_STONE_HP: INTEGER = 1000000;
  MOB_GUARD_HP: INTEGER = 1000000;
  EXP_MULTIPLIER: WORD = 2;
  PENA_DE_GELO_MULT: INTEGER = 50;
  ...
  SKULL_PENA:WORD = 1;
const
  MAX_BYTE_SIZE :INTEGER = 100655350;
  MAX_WORD_SIZE :INTEGER = 100655350;
  MIN_BYTE_SIZE :INTEGER = 0;
  MIN_WORD_SIZE :INTEGER = 0;
  ACCEPT_CONNECTIONS_DELAY = 1; // Delay em miliseconds
  // ajuste macro e skill
  MAX_SPAWN_ID = 30000;
  AI_DELAY_MOVIMENTO = 2000;
  MIN_DELAY_SKILL =300;  // (ms)
  MIN_DELAY_ATTACK = 300; // (ms)
  MIN_DELAY_ATTACK_Skill  = 350;// (ms)
  ...
  leopold2 = 22;
  heclasuperior = 23;
  heclasuperiorboss = 24;
  heclainferior= 25;
  heclainferiorboss = 26;
  mina1=27;
  mina1boss = 28;
  ungor = 29;
  ungorboss = 30;
  ...
  { Refinamento }
  ChancesOfRefinament: Array [0..11] of Byte = (100, 100, 100, 100, 100, 100, 100,
  90, 80 ,60 , 25, 0);
...
{$REGION 'Effects'}
  ...
  EF_DUNGEON_ON = 394;
  EF_HP_ATK_RES = 395;
  //Variavel para determinar porcentagem
  MAX_PERCENTAGE = 100;
  TAXA_AUXILIAR = 75;
  TAXA_AUXILIAR_MISS = 60;
...
{$REGION 'ATACQUE PADRÃO CLASSSES'}
  WAR_ATACK : SINGLE = 5.8;
  TP_ATACK : SINGLE = 6.7;
  DUAL_ATACK : SINGLE = 7.5;
  ATT_ATACK : SINGLE = 7.5;
  FC_ATACK : SINGLE = 3;
  SANTA_ATACK : SINGLE = 3;

  {$REGION 'ATACQUE skill CLASSSES em %'}
  WAR_ATACK_SKILL : SINGLE = 2;
  TP_ATACK_SKILL : SINGLE = 2;
  DUAL_ATACK_SKILL : SINGLE = 2;
  ATT_ATACK_SKILL: SINGLE = 1;
  FC_ATACK_SKILL: SINGLE =1;
  SANTA_ATACK_SKILL: SINGLE = 1;


{$REGION 'LIMITE DE STATUS'}

  DUPLO_ATAQUE_INFO: Integer = 1200;
  TAXA_CRITICO_INFO: Integer = 5530;
  DANO_CRITICO_INFO: Integer = 2200;
  TAXA_DE_CURA_INFO: Integer = 1000;
  RESISTENCIA_TAXA_CRITICO_INFO: Integer = 3900;
  RESISTENCIA_A_DANO_CRITICO_INFO: Integer = 5600;
  RESISTENCIA_A_DUPLO_INFO: Integer = 1200;
  RESISTENCIA_INFO: Integer = 1600;
  FORCA_INFO: Integer = 1500;            // Força
  AGILIDADE_INFO: Integer = 1500;
  INTELIGENCIA_INFO: Integer = 1500;
  CONSTITUICAO_INFO: Integer = 1500;     // Constituição
  SORTE_INFO: Integer = 1500;
  ESQUIVA_INFO: word = 240;
  ACERTO_INFO: word = 255;
  MAX_HAB_ATK: integer = 50000;

  TDANOCRITICO = 10; // AUMENTA O VALOR ATUAL
  TRESDANOCRITICO = 1;  // AUMENTA O VALOR ATUAL
  TTAXACRITICA = 10;   // AUMENTA O VALOR ATUAL
  TRESTAXACRITICA = 1;  // AUMENTA O VALOR ATUAL


  {$REGION 'LIMITE DE STATUS ALCANÇADOS'}

  QTDA_STATUS :Integer = 1 ;



{$REGION 'porcentagem drops mobs dgs'}
  DROP_DG = 10;
  DROP_DG_BOSS = 80;
  DANO_BOSS = 1 ;
  DANO_MOBS_DG = 100;
  ...
  {$REGION 'Maximo dano PVP'}

   DAMO_MAX_PCP =1500000; // level 85
   DAMO_MAX_PCP95 =4500000;// llevel 95  mob
   DAMO_MAX_MOB= 40000000; //*6 = 280000 dano nos mobs
   DANOMAXIMO =40000000;
   DANOMAXIMO_LVL99= 3500000; // level 99
   DANOMAXIMO_LVL95= 2500000; // level 95
   MAX_CRITICAL_DAMAGE = 8000000;
   MAX_CRITICAL_DAMAGE99= 9000000;
   MAX_CRITICAL_DAMAGE95= 8500000;

   // MDUPLO CRITICO
   MAX_CRITICAL_DAMAGE2 = 18000000;
   MAX_CRITICAL_DAMAGE992= 19000000; // level 99
   MAX_CRITICAL_DAMAGE952= 18500000; // level 95
   // VARIAÇÃO DE DANO
   MINP_DANO_LVL85 = 1500000;
   MINP_DANO_LVL96 = 4500000;
   MINP_DANO_LVL98 = 40000000;


   {$REGION 'Maximo dano PVP Royale'}

    OUTRO_DAMO_MAX_PCP = 10000;
    MIN_DANO_LVL85 = 1000;
    OUTRO_DANOMAXIMO_LVL95 = 20000;
    MIN_DANO_LVL96 = 1000;
    OUTRO_DANOMAXIMO_LVL99 = 25000;
    MIN_DANO_LVL98 = 1000;

 {$REGION 'Maximo dano '}
   DANOGERALPVP =  100; // reduz 50%
   DANOGERALMOB =  4.5;// reduz 150 %
    CURAPLAYER = 1;
   //  DANOGERALMOBs =  0.1;// reduz 90 %

   DANODISCONECT1= 2000000000;
   DANODISCONECT2 = 3000000000;
   DANODISCONECT3= 8100000000;
...
{$REGION HP E MP ADCIONAL'}
    ...
    HPPLAYER = 0.01; // TAVA 15.3
    MPPLAYER = 0.01; // TAVA 12.3
...
{$REGION 'Melhorador de Set 10%'}

   MELHORADOR_DANO = 0.9;
   MELHORADOR_DEFIS = 0.9;
   MELHORADOR_DEMAG = 0.9;
   MELHORADOR_PVP_DAMAGE = 1000;
   MELHORADOR_PVP_DEFENSE= 1000;
   MELHORADOR_DANO_CRITICO= 50;
   MELHORADOR_TAXA_CRITICO= 50;
   MELHORADOR_RESTAX_CRITICO= 50;
   MELHORADOR_RESDANO_CRITICO= 50;

    {$REGION 'Melhorador de Set 5%'}

   MELHORADOR_DANO5 = 0.4;
   MELHORADOR_DEFIS5 = 0.4;
   MELHORADOR_DEMAG5 = 0.4;
   MELHORADOR_PVP_DAMAGE5 = 2000;
   MELHORADOR_PVP_DEFENSE5= 2000;
   MELHORADOR_DANO_CRITICO5= 50;
   MELHORADOR_TAXA_CRITICO5= 50;
   MELHORADOR_RESTAX_CRITICO5= 50;
   MELHORADOR_RESDANO_CRITICO5= 50;
...
// Inicializa a lista de canais
  ...
  // Obtém o dia da semana atual (1 = Domingo, 2 = Segunda, ..., 7 = Sábado)
var DayOfWeek := DayOfTheWeek(Now);

// Verifica se não é domingo (1) e ajusta o multiplicador
if (DayOfWeek <> 1) then // Multiplica em todos os dias, exceto no domingo
  SKULL_MULTIPLIER := 4 // Multiplicador ajustado para 2
else
  SKULL_MULTIPLIER := 1; // Multiplicador padrão no domingo
