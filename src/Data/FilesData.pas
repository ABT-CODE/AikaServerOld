...
type
  ...
  Reinforce2_Area_Blade = 0,
	Reinforce2_Area_Sword = 35, // era 35
	Reinforce2_Area_Pistol = 70, // era 70
	Reinforce2_Area_Rifle = 105, // era 105
	Reinforce2_Area_Wand = 140,  // era 140
	Reinforce2_Area_Staff = 175,  // era 175
	Reinforce2_Area_Helmet = 210, // era 210
	Reinforce2_Area_Armor = 390,  // era 390
	Reinforce2_Area_Gloves = 570,  // era 570
	Reinforce2_Area_Shoes = 750,   // era 750
	Reinforce2_Area_Shield = 930   // era 930
  );
const reinforce2sectionSize : WORD = 960;  // 960 dividido por 4
{$ENDREGION}
{$REGION 'Reinforce3'}
type
...
type
  Reinforce3_Area_ = (
    ...
    Reinforce3_Area_Armor = 30, // era 30
    Reinforce3_Area_Gloves = 60, // era 60
    Reinforce3_Area_Shoes = 90   // era 90
  );
const reinforce3sectionSize : WORD = 150;    // era 150 dividi por 4
...
type
  TMobDrops = Array [0..50] of TMobDropList; //quantidade arquivos drops
