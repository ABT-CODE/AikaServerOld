...
begin
  Result := False;
  SPlayer := SelfPlayer;
 // Logger.Write('1.0 criar guild', TLogType.Error);
 ...
 // Servers[ChannelId].cSQL.AddParameter2('pguild_count', GuildCnt);
  ...
  begin
    ...
    //  Logger.Write('1.2 criar guild', TLogType.Error);
  end;
  //for tava aq
  { Save Guild at MySQL }
  try
    ...
    //  Logger.Write('1.3 criar guild', TLogType.Error);
    ...
    if Self.Members[I].CharIndex > 0 then
      ...
      //Logger.Write('1.4 criar guild', TLogType.Error);
    for M := 0 to 127 do
    begin
    ...
    //Logger.Write('1.5 criar guild', TLogType.Error);
